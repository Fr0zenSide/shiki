...
For projects managed via Shiki (`shikki/projects/<name>/`):
...
2. Read .claude/skills/shikki-process/sdd-protocol.md (from main repo, read-only)
3. Read .claude/skills/shikki-process/verification-protocol.md (from main repo, read-only)
