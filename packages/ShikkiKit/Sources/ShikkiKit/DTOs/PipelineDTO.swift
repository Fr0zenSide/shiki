...
public struct PipelineCheckpointInput: Codable, Equatable, Sendable, Validatable {
    ...
    public func validate() throws {
        ...
        if phaseIndex < 0 {
            throw ShikkiValidationError.fieldMustBeNonNegative("phaseIndex")
        }
        if let durationMs, durationMs < 0 {
            throw ShikkiValidationError.fieldMustBeNonNegative("durationMs")
        }
    }
...
public struct PipelineRoutingRuleInput: Codable, Equatable, Sendable, Validatable {
    ...
    public func validate() throws {
        ...
        if priority < 0 || priority > 100 {
            throw ShikkiValidationError.fieldOutOfRange("priority", min: 0, max: 100)
        }
    }
