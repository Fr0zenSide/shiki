...
public enum ShikkiError: Error, Equatable, Sendable {
...
extension ShikkiError: CustomStringConvertible {
    public var description: String {
        "ShikkiError.\(code)(\(statusCode)): \(message)"
    }
}
...
extension ShikkiError {
    /// Creates a `.validationFailed` error from a `ShikkiValidationError`.
    public static func fromValidation(_ error: ShikkiValidationError) -> ShikkiError {
        switch error {
