...
public enum AgentMessages {
    ...
    public static func question(fromSession: String, toSession: String, question: String) -> ShikkiEvent {
        ShikkiEvent(
    ...
    public static func result(sessionId: String, summary: String) -> ShikkiEvent {
        ShikkiEvent(
    ...
    public static func handoff(fromSession: String, toPersona: AgentPersona, context: String) -> ShikkiEvent {
        ShikkiEvent(
            source: .agent(id: fromSession, name: nil),
    ...
    public static func broadcast(message: String) -> ShikkiEvent {
        ShikkiEvent(
            source: .orchestrator,
    ...
    public static func decisionGate(sessionId: String, question: String, tier: Int) -> ShikkiEvent {
        ShikkiEvent(
            source: .agent(id: sessionId, name: nil),
