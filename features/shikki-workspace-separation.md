...
│   │   ├── .build/workspace-state.json (SPM-managed, gitignored)        ← auto-generated by shi ws setup (gitignored)
│   │   ├── memory/
│   │   ├── features/
│   │   ├── reports/
│   │   └── .shikki-quality
...
│       ├── .build/workspace-state.json (SPM-managed, gitignored)        ← auto-generated, maps Package.swift URLs → local paths
│       ├── memory/
│       ├── features/
│       └── reports/
```
