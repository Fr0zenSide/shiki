...
public struct ANSIEventRenderer: EventRenderer {
    ...
    public func render(_ event: ShikiEvent) -> String {
    ...
    func formatPayloadSummary(_ event: ShikiEvent) -> String {
        var parts: [String] = []
    ...
    func extractCompanySlug(from event: ShikiEvent) -> String {
        switch event.scope {
